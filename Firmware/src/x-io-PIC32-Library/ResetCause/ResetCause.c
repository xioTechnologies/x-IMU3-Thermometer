...
RCON_RESET_CAUSE ResetCauseGet(void) {
    ...
    const RCON_RESET_CAUSE mask = RCON_RESET_CAUSE_POR | RCON_RESET_CAUSE_BOR | RCON_RESET_CAUSE_IDLE | RCON_RESET_CAUSE_SLEEP | RCON_RESET_CAUSE_WDTO | RCON_RESET_CAUSE_SWR | RCON_RESET_CAUSE_EXTR | RCON_RESET_CAUSE_CMR | RCON_RESET_CAUSE_BCFGFAIL | RCON_RESET_CAUSE_BCFGERR | RCON_RESET_CAUSE_PORCORE | RCON_RESET_CAUSE_PORIO;
...
void ResetCausePrint(const RCON_RESET_CAUSE cause) {
    ...
    if ((cause & RCON_RESET_CAUSE_PORCORE) != 0) {
        printf("PORCORE ");
    }
    if ((cause & RCON_RESET_CAUSE_PORIO) != 0) {
        printf("PORIO ");
    }
